    ...
    >
      <header
        className={clsx(
          ...
          {
            "!bg-black !border-gray-200": !isHome || isScrolled,
          }
        )}
      >
        <nav
          className={clsx(
            "text-white group-hover:text-white flex items-center justify-between w-full h-full text-small-regular transition-colors duration-200",
          )}
        >
