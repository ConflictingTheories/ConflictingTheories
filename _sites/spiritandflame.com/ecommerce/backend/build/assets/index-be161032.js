...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var da=$a,ha=ya,ga=ma,F;da()?F=ha:F=ga;var Sa=F;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var de=ye,he=be,ge=me,M;de()?M=he:M=ge;var V=M;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var gt=bt,U=mt,er=ht;function St(){var r,a;if(typeof er!="function")return!1;try{a=[1,3.14,-3.14,U+1,U+2],a=new er(a),r=gt(a)&&a[0]===1&&a[1]===3&&a[2]===U-2&&a[3]===0&&a[4]===1}catch{r=!1}return r}var wt=St;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Vt=V,xt=x,dr=Bt,hr=new xt(1),nr=new Vt(hr.buffer),Jt=dr.HIGH,qt=dr.LOW;function zt(r,a,e,t){return hr[0]=r,a[t]=nr[Jt],a[t+e]=nr[qt],a}var gr=zt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var mn=oa,dn=fa,hn=wr,gn=Nr,Sn=Pr,E=[0,0];function wn(r,a){var e,t;return hn.assign(r,E,1,0),e=E[0],e&=dn,t=gn(a),t&=mn,e|=t,Sn(e,E[1])}var On=wn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
